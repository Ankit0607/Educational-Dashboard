    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <h3 class="mb-4">
                        <a class="btn btn-primary d-none d-sm-inline-block float-right" role="button" href="add_year.php"><i class="fas fa-plus fa-sm text-white-50"></i>&nbsp;Add Year</a><br/>
                    </h3>
                                ...
                                <table class="table dataTable my-0 table-hover" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_year.php?id=<?php echo $row['id']; ?>">
                                                <i class="fa fa-pencil"></i></a>
                                            </td>
                                            <td>
                                                <a href="del_year.php?id=<?php echo $row['id']; ?>">
