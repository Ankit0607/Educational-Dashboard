                ...
                <form action="" method="POST">
                    <div class="card shadow mb-" style="margin-top:30px;">
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" value="" name="uid" required />
                            ...
                            <input type="password" name="cpass" value="" class="form-control" required/>
                            <br/>
                            <button type="submit" class="btn btn-primary" name="b1">Sin Up</button>
