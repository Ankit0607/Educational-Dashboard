    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <h3 class="mb-4">
                        <a class="btn btn-primary d-none d-sm-inline-block float-right" role="button" href="add_subject.php"><i class="fas fa-plus fa-sm text-white-50"></i>&nbsp;Add Subject</a><br/>
                </h3>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="text-primary font-weight-bold m-0">Manage Subject&nbsp;</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <table class="table dataTable my-0 table-hover" id="dataTable">
                                        ...
                                        while($row=mysqli_fetch_array($res)){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="del_subject.php?id=<?php echo $row['id']; ?>">
