                ...
                <form action="" method="POST">
                    <div class="card shadow mb-" style="margin-top:30px;">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h6 class="text-primary font-weight-bold m-0">New Subject</h6>
                        </div>
                        <div class="card-body">
                            <!-- <form action="" method="POST"> -->
                            <label>Subject ID</label>
                            <input type="text" name="sid" value="" class="form-control" required/>
                            <label><br/>Subject Name</label>
                            <input type="text" class="form-control" value="" name="name" required />
                            <label><br/>Branch ID</label>
                            <input type="text" name="bid" value="" class="form-control" required/>
                            <br/>
                            ...
                            <?php
                                if(isset($_POST["b1"])){
                                    ...
                                    $sql="INSERT INTO tbl_subject (id,subject_name,branch_id) VALUES ($sid,'$name','$bid')";
