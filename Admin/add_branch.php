                ...
                <form action="" method="POST">
                    <div class="card shadow mb-" style="margin-top:30px;">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h6 class="text-primary font-weight-bold m-0">New Branch</h6>
                        </div>
                        <div class="card-body">
                            <!-- <form action="" method="POST"> -->
                            <label>Branch ID</label>
                            <input type="text" name="bid" value="" class="form-control" required/>
                            <label><br/>Branch Name</label>
                            <input type="text" class="form-control" value="" name="name" required />
                            <label><br/>Year ID</label>
                            <input type="text" name="yid" value="" class="form-control" required/>
                            <br/>
                            ...
                            <?php
                                if(isset($_POST["b1"])){
                                    ...
                                    $sql="INSERT INTO tbl_branch (id,branch_name,year_id) VALUES ($bid,'$name','$yid')";
