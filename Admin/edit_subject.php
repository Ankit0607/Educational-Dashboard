                ...
                <form action="" method="POST">
                    <div class="card shadow mb-" style="margin-top:30px;">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h6 class="text-primary font-weight-bold m-0">Edit Subject</h6>
                        </div>
                        <div class="card-body">
                            <?php
                                $id=$_GET['id'];
                            ...
                            <label><br/>Subject Name</label>
                            <input type="text" name="name" value="<?php echo $row['subject_name']; ?>" class="form-control"/>
                            <label><br/>Branch ID</label>
                            <input type="text" name="bid" value="<?php echo $row['branch_id']; ?>" class="form-control"/>
                            <br/>
                            ...
                            <?php
                                if(isset($_POST["b1"])){
                                    ...
                                    $name=$_POST["name"];
                                    $year=$_POST["bid"];
                                    $sql="update tbl_subject set subject_name='$name',branch_id='$year' where id=$id";
