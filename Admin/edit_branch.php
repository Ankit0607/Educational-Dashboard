                ...
                <form action="" method="POST">
                    <div class="card shadow mb-" style="margin-top:30px;">
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" name="name" value="<?php echo $row['branch_name']; ?>" class="form-control"/>
                            <label><br/>Year ID</label>
                            <input type="text" name="year" value="<?php echo $row['year_id']; ?>" class="form-control"/>
                            <br/>
                            ...
                            <?php
                                if(isset($_POST["b1"])){
                                    ...
                                    $name=$_POST["name"];
                                    $year=$_POST["year"];
                                    $sql="update tbl_branch set branch_name='$name',year_id='$year' where id=$id";
