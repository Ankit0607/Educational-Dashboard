                            ...
                            <div class="row">
                                <div class="col">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label
                                                                for="username"><strong>I.D.</strong></label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group"><label for="dob"><strong>D.O.B.</strong></label>
                                                        <?php echo "<br>".$dob; ?></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                            <div class="form-group"><label for="email"><strong>E-Mail I.D.</strong></label>
                                                                        <?php echo "<br>".$email; ?>
                                                                </div>
                                                        </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="contact"><strong>Phone Number</strong></label>
                                                        <?php echo "<br>".$phno; ?></div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card shadow">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 font-weight-bold">Academic Details</p>
                                        </div>
                                        <div class="card-body">
                                            <form>
                                            <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label
                                                                for="college"><strong>College</strong></label><?php echo "<br>".$college; ?></div>
                                                    </div>
                                                    <div class="col">
                                                            <div class="form-group"><label
                                                                    for="course"><strong>Course</strong></label><?php echo "<br>".$course; ?></div>
                                                        </div>
                                                ...
                                                <div class="col">
                                                        <div class="form-group"><label
                                                                for="branch"><strong>Branch</strong></label><?php echo "<br>".$branch; ?></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label
                                                                for="year"><strong>Year</strong></label><?php echo "<br>".$year; ?></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label
                                                                for="section"><strong>Section</strong></label><?php echo "<br>".$section; ?></div>
                                                    </div>
                                                </div>
